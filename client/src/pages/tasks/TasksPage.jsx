    ...
    <div className="mt-modal-scrim open" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="mt-modal">
        ...
        <div className="mt-modal-body">
          ...
          <div className="mt-fld"><label className="mt-fld-label">Description</label><textarea className="mt-input" style={{ minHeight: 200, resize: 'vertical' }} placeholder="Add any detail…" value={description} onChange={e => setDescription(e.target.value)} /></div>
