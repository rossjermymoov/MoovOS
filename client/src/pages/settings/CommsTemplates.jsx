      ...
      <div className="mv-page-inner">
        ...
        {!loading && couriers.length > 0 && (
          <>
            ...
            {/* Known copy-paste non-answers */}
            <div style={{ background: 'var(--mv-surface)', border: '1px solid var(--mv-hairline-2)', padding: 18, marginBottom: 22 }}>
              <div className="mv-kicker">Reply Interpreter</div>
              <label style={{ fontSize: 13, fontWeight: 800, color: 'var(--mv-ink)', display: 'block', marginBottom: 4 }}>🚩 Known Non-Answer Phrases</label>
              <p style={{ fontSize: 11.5, color: 'var(--mv-ink-52)', margin: '0 0 10px' }}>
