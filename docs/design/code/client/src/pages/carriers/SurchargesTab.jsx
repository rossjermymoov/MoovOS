...
const inp = (extra = {}) => ({
  ...
  borderRadius: 'var(--v2-r-sm)', color: 'var(--mv-ink)', fontSize: 13, padding: '6px 10px',
...
function ChipInput({ value, onChange, placeholder }) {
  ...
  return (
    <div style={{ border: '1px solid var(--mv-hairline-2)', borderRadius: 'var(--v2-r-sm)', background: 'var(--mv-bg)', padding: '4px 8px', minHeight: 36, display: 'flex', flexWrap: 'wrap', gap: 4, alignItems: 'center' }}>
      {items.map((item, i) => (
        <span key={i} style={{ display: 'inline-flex', alignItems: 'center', gap: 4, background: 'var(--mv-purple-100)', border: '1px solid var(--mv-purple-200)', borderRadius: 'var(--v2-r-pill)', padding: '2px 8px', fontSize: 11, color: 'var(--mv-purple-700)', fontWeight: 600 }}>
          {item}
