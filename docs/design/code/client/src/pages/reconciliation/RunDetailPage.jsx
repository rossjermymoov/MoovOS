...
function TraceModal({ runId, lineId, trackingNumber, onClose }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: 'var(--v2-code-bg)', borderRadius: 'var(--v2-r-md)', border: '1px solid var(--mv-hairline)',
        padding: 24, width: 640, maxHeight: '80vh',
      ...
      {tooltipPos && createPortal(
        ...
        >
          ...
          <div style={{
            ...
            width: 10, height: 10, background: 'var(--v2-code-bg)',
...
function RaiseQueryModal({ line, runId, carrierId, invoiceRef, onClose, onRaised }) {
  ...
  const modal = {
    background: 'var(--v2-code-bg)', borderRadius: 'var(--v2-r-md)', border: '1px solid var(--mv-hairline)',
    padding: 24, width: 500, maxHeight: '90vh',
    overflowY: 'auto', boxShadow: '0 24px 64px color-mix(in srgb, var(--mv-ink) 60%, transparent)',
  };
