      ...
      {showInjectModal && (
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 'var(--v2-r-lg)', borderTop: '2px solid var(--mv-purple)',
            padding: 24, boxShadow: 'var(--v2-lift-modal)'
          }}>
      ...
      {selectedShipment && (
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 'var(--v2-r-lg)', borderTop: '2px solid var(--mv-purple)', overflow: 'hidden',
            display: 'flex', flexDirection: 'column', boxShadow: 'var(--v2-lift-modal)'
          }}>
            {/* Modal Header */}
