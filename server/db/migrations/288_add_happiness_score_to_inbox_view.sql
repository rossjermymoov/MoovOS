-- Migration 288: Add customer_happiness_score to queries_inbox_view
-- Joins customers table to surface health_score on every ticket row.
...
SELECT
  ...
  -- Customer happiness score (from customers.health_score)
